...
#endif
#if SOC_RMT_MEM_WORDS_PER_CHANNEL < 48
#error "ESP32 variant has insufficient RMT memory for DCC output"
#elif SOC_RMT_MEM_WORDS_PER_CHANNEL < 64
#warning "ESP32-S3/C3-class RMT: 48 words per channel; DCC packets use two TX channels"
#endif
...
RMTChannel::RMTChannel(pinpair pins, bool isMain) {
  ...
  // Pre-filling TX RAM alone does not begin transmission on ESP-IDF RMT.
  // Start from item zero after loading the initial preamble/idle sequence.
  RMTprefill();
